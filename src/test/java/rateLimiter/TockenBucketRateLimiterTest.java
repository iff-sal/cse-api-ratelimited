...
public class TockenBucketRateLimiterTest {

    private static RedisContainer redisContainer;
    private Jedis jedis;
    private TockenBucketRateLimiter rateLimiter;
    ...
    void shouldAllowRequestsWithinBucketCapacity() {
        rateLimiter = new TockenBucketRateLimiter(jedis, 5, 1.0);
        for (int i = 1; i <= 5; i++) {
    ...
    void shouldAllowBurstsUpToBucketCapacity() {
        rateLimiter = new TockenBucketRateLimiter(jedis, 10, 2.0);
    ...
    void shouldRefillTokensUpToCapacityWithoutExceedingIt() throws InterruptedException {
        ...
        String clientId = "client-1";
        rateLimiter = new TockenBucketRateLimiter(jedis, capacity, refillRate);
